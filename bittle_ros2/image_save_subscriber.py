...
class Save_Image(Node):
    def __init__(self):
        ...
        self.base_directory_p = r'/home/rithwik/bittle/video_to_image/train/2/positive_reverse'
        self.base_directory_n = r'/home/rithwik/bittle/video_to_image/train/2/negative_reverse'
